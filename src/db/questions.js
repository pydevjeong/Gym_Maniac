export const questions = [
  ...
  {
    number:2,
    questionText: "평소 식사시 단백질을 생각하고 대략적인 계산이 가능한가?",
    answerOptions: [
      { answerText: "생각안함", addPoint:1 },
      { answerText: "생각은 하지만 계산하면서 까지 먹지 않음", addPoint:2 },
      { answerText: "생각하고 계산함", addPoint:3 },
      { answerText: "식사가 정해져 있음(계산할 필요가 없음)", addPoint:4 },
    ]
  },
  {
    number:3,
    questionText: "현재 몸상태는 어떤가?",
    answerOptions: [
